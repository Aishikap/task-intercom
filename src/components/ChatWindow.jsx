...
const ChatWindow = () => {
  ...
  className={`px-4 py-2 rounded-2xl text-sm shadow-sm ${
    isAgent
      ? "bg-blue-100 dark:bg-intercom-blue text-black dark:text-white rounded-bl-2xl rounded-br-none"
      : "bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-white rounded-br-2xl rounded-bl-none"
  }`}
>
